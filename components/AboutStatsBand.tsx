...
export default function AboutStatsBand({ stats }: { stats: Stat[] }) {
  ...
  return (
    <section className="relative z-0 bg-primary/55 py-8 text-on-dark md:py-10">
            ...
            return (
              ...
              >
                <div className="flex min-h-[3.2rem] items-center justify-center sm:min-h-16">
                  <span className="text-[1.85rem] font-light uppercase leading-none tracking-tight text-white sm:text-[2.8rem]">
                    {isNumber ? (
                ...
                <div className="mt-4 flex min-h-14 items-start justify-center">
                  <span className="inline-flex max-w-[18ch] items-center justify-center bg-bg-darker/60 px-3 py-1.5 text-[0.64rem] font-medium uppercase leading-relaxed tracking-[0.12em] text-on-dark sm:text-[0.7rem]">
                    {stat.label}
                  </span>
                </div>
              </motion.div>
